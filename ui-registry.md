...
| Shadow           | header `shadow-[0_18px_40px_rgba(0,0,0,0.32)]`, header player `shadow-[0_0_0_1px_rgba(255,255,255,0.03)]`, opened media `box-shadow:0 10px 30px rgba(0,0,0,.35)`, dome glow `blur(38px)` with gold/ivory radial wash, loading tiles use layered pink/gold/blue outer glow plus inset white edge |
| Accent usage     | CTA `bg-[#c79a31] text-[#131110]`, player active bars `bg-[#c79a31]` and `bg-[#e8d5a4]`, player slider `accent-[#c79a31]`, DomeGallery overlay blur `#101212`, loading sheen blends pink, gold, cyan, and blue, loading borders use an animated spectrum frame, retry pulse briefly intensifies the lit border treatment |
