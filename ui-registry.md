...
| Text - primary   | `text-[#f2ede4]` |
| Text - secondary | `text-[#beb7af]`, muted `text-[#8f887e]` |
| Spacing          | section `px-4 py-10 sm:px-8 sm:py-16 lg:px-10 lg:py-24`, gallery `h-[210px] min-[400px]:h-[240px] sm:h-[520px]`, player uses centered `w-[calc(100vw-0.5rem)] max-h-[calc(100dvh-0.5rem)] p-0.5` on very small screens and `sm:w-[calc(100vw-1.5rem)] sm:max-h-[calc(100dvh-1.5rem)] sm:p-2` on larger screens |
